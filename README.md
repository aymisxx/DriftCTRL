...
This project applies and evaluates major reinforcement learning algorithms (PPO, DQN and A2C) on the CarRacing-v3 environment from OpenAI Gymnasium. It demonstrates performance comparisons between continuous and discretized control strategies, along with training logs, reward analysis, and video recordings of agent behavior.
...
### DQN (Deep Q-Network w/ Custom Discretization)
- **Behavior:**  
...
Ayushman M.
MS, Robotics and Autonomous Systems (Mechanical & Aerospace) – Arizona State University  
